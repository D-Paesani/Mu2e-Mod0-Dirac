...
void ANA_CLASS_NAME::NamerLayerDiff(int histN, TString& hTag, TString& hTitleTag, void *anaVars, TString hOpt) { 
  
  AnaVars *vars = (AnaVars*) anaVars;
  hTag = "_" + vars->RES.layerDiffList[histN];
  hTitleTag = " " + vars->RES.layerDiffList[histN];
}
